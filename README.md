...
Streamlitで動く“おしゃれな個人サイト”テンプレです。

## できること

- **ホーム**で全体像が一目で分かる（自己紹介 / 最新note / Shopify / Instagram / Threads / 勉強会 / 市場指数）
...
- `static/market.json`：APIキー未設定時の市場指数の表示用（任意で更新）
